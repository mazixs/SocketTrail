...
- Плашка **SNI** значит, что имя взято из рукопожатия TLS или QUIC этого самого
  соединения. Это самый надежный источник.
...
1. SNI из ClientHello этого соединения: TLS поверх TCP или QUIC.
